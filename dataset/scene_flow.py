...
class SceneFlowFlyingThingsDataset(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        occ_left_fname=left_fname.replace("image_clean","disparity_occlusions")
        occ_right_fname=right_fname.replace("image_clean","disparity_occlusions")
        ...
        disp_right_fname = right_fname.replace('image_clean', 'disparity').replace('.png', '.pfm')
