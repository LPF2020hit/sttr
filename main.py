...
def get_args_parser():
    ...
    parser.add_argument('--dataset_directory', default='/opt/disk2/FlyingThings3D_subset/', type=str, help='directory to dataset')
...
def main(args):
    ...
    # build dataloader
    data_loader_train, data_loader_val = build_data_loader(args)
